...
print("Eger hazirsaniz sorularimiza gecelim : ")
    ...
    #Degisken Degerleri tanimliyoruz
soru = 0
half_joker = 1
pas_joker = 1
change_question = 1
...
while soru < 10:
    ...
    #Soruyu ve secenekleri yazdiriyoruz
    ...
    # Pas - Change ve Half jokerlerinin kullanimi
    if answer == "PAS" and pas_joker >0:
        ...
        #Dogru cevap disindakileri wrong_options degiskenine aktariyor ve bunlardan 2 tanesini kaldiriyoruz.
