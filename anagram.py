#Kelime listesinii import et
#Kelime uzunluklarına göre seviye dizelerine ekle
#Kontrol koşul algoritmaları ile kullanicidan seviye seçmesini iste
#Seçilen seviyedeki bir kelimeyi ayırıp karıştır
#Kullanicinin girişi ile kelimenin aslini kontrol et
