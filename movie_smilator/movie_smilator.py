...
film_adi = df["Film Adi"]
Genre = df["Türü"]
Year = df["Yil"]
imdb = df["Puan"]

print("Kategoriler : \n")
user_input = input("\tA) Türü\n\tB) Yil\n\tC) Puan\n\nLütfen filmleri siralamak istediğiniz kriteri yaziniz  : ").upper()
if user_input == 'A':
    ...
    print(filtered_movies[["Film Adi","Yil","Puan"]] , "\n")

elif user_input == "B":

    araliklar = [1970,1980,1990,2000,2010,2020]
    tags = ["1970-1980","1980-1990","1990-2000","2000-2010","2010-2020"]    
    df["Yil Araligi"] = pd.cut(df["Yil"],bins=araliklar, labels=tags,right=False)
    
    print("\nMevcut Yil Araliklari : \n")
    ...
    filtered_movies = df[df["Yil Araligi"] == selected_year] 
    ...
    print(filtered_points[["Film Adi","Yil","Puan"]],"\n")
