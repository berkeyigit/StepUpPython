#Random harf belirlenecek
#Bu harfte isim şehir hayvan ülke bitki girmeye çalışacak kullanıcı
#Girdikleri veri tabanı ile eşlesmiyor ise puan kazanamayacak
#Başkasi ile oynuyormuş hissi vermesi için bilgisayarda üretsin random kütüphanesi ile. Eğer aynı olursa daha az puan alacak.

#EDIT : Flag denilen şeyi chatgpt yardımı ile yaptım. Aklima gelmemişti.
        ...
        if user_input.upper() == "Q":
            ...
            if user_input in data_files[category].values:
                ...
                if computer_choise == user_input:
                    ...
                    print(f"Diger oyuncu ile ayni {category} kullandiniz. Bu yüzden sadece 5 puan kazandiniz.\n")
                    puan += 5
                else:
                    print(f"{category} doğru!")
